...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 max-w-7xl mx-auto px-6 md:px-12 relative w-full">
      <motion.div
            ...
            >
              ...
              <div className="p-8 md:w-3/5 overflow-y-auto">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-primary text-xs font-black uppercase tracking-widest mb-2">Detailed Summary</h4>
