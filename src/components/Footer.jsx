...
const Footer = () => {
  return (
    <footer className="w-full border-t border-gray-800 bg-[#0d1117] py-8 text-center mt-24">
      <div className="container mx-auto px-6 max-w-6xl flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="w-10 h-10 rounded-full bg-gray-900 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-500 hover:shadow-[0_0_15px_rgba(88,166,255,0.4)] transition-all"
            aria-label="GitHub"
          >
            <Github size={18} />
          </a>
