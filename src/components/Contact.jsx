      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        >
          <div className="glass p-8 rounded-2xl flex items-start gap-4">
            <div className="w-12 h-12 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0 text-blue-400">
              <Mail size={24} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Email</h3>
              <p className="text-gray-400">ruthra1645@gmail.com</p>
              <a href="mailto:ruthra1645@gmail.com" className="text-blue-400 hover:text-blue-300 text-sm font-semibold mt-2 inline-block">
                Send a message 
              </a>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="bg-gray-900/50 border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="bg-gray-900/50 border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors resize-none"
